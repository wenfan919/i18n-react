...
const proxyConfig = [
  ...
  // 后台开发服务
  {
    ...
    headers: {
      // 这是之前网页的地址，从中可以看到当前请求页面的链接。
      "Referer": "http://i18n-provider.dev.app.yyuap.com"
    },
    // context，如果不配置，默认就是代理全部。
    router: [
      '/i18n'
    ...
    url: 'http://i18n-provider.dev.app.yyuap.com'
  },
...
const globalEnvConfig = new webpack.DefinePlugin({
  ...
  GROBAL_HTTP_CTX: JSON.stringify("")
  // GROBAL_HTTP_CTX: JSON.stringify("/i18n-provider")
})
